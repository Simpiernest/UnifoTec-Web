...
export default function CustomSoftwareDetailPage() {
  const keyFeatures = [
    {
      title: "Scalable Microservices Architecture",
      desc: "Distributed backend systems designed to handle millions of requests with horizontal auto-scaling capabilities.",
      icon: Server,
    },
    {
      title: "Tailored Business Logic",
      desc: "Custom-coded algorithms specifically architected to mirror your unique organizational workflows and rules.",
      icon: Workflow,
    },
    {
      title: "Robust Database Engineering",
      desc: "Relational and non-relational database designs optimized for high-speed indexing and data integrity.",
      icon: Database,
    },
    {
      title: "Enterprise Security Protocols",
      desc: "Role-based access control (RBAC), end-to-end encryption, and rigorous audit logging for compliance.",
      icon: ShieldCheck,
    },
  ];
  ...
  const useCases = [
    {
      ...
      desc: "Comprehensive resource planning software tailored for manufacturing, logistics, or service-based enterprises.",
    },
    {
      title: "Advanced CRM Platforms",
      desc: "Customer relationship management tools integrated with deep analytics and automated sales pipelines.",
    },
    {
      title: "Real-time Data Dashboards",
      desc: "Complex data visualization platforms consuming high-frequency IoT or financial data streams.",
    },
  ];

  const techStack = [
    { name: "Node.js", desc: "Event-driven runtime for high-throughput API backends.", category: "Backend" },
    { name: "Python", desc: "Ideal for complex data processing and AI/ML integrations.", category: "Language" },
    { name: "PostgreSQL", desc: "Reliable relational database for complex transaction schemas.", category: "Database" },
    { name: "Redis", desc: "Ultra-fast in-memory data store for caching and pub/sub.", category: "Caching" },
    { name: "Docker", desc: "Containerization for consistent deployment across environments.", category: "DevOps" },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <MDiv variants={staggerContainer} initial="hidden" animate="visible" className="lg:w-3/5">
              ...
              <p className="text-grey text-lg font-medium leading-relaxed max-w-xl">
                We build powerful, scalable, and secure backend architectures that automate your complex business operations.
              </p>
            </MDiv>
            <MDiv variants={scaleIn} initial="hidden" animate="visible" className="lg:w-2/5 w-full bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-2">Automate your backend?</h3>
              <p className="text-slate-400 text-sm font-medium mb-6">Let's design a custom software architecture that grows with your business complexity.</p>
      ...
      <MotionSection className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold text-accent uppercase tracking-widest mb-2">Architectural Standards</h2>
            <h3 className="text-3xl font-bold text-dark">Key Software Features</h3>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-grey text-sm max-w-md mx-auto mt-2">
              We leverage the most stable and performant technologies for long-term maintainability.
            </p>
          </div>
